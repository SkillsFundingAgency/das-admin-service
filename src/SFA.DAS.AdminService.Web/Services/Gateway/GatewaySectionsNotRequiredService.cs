...
namespace SFA.DAS.AdminService.Web.Services.Gateway
{
    public class GatewaySectionsNotRequiredService : IGatewaySectionsNotRequiredService
    {
        ...
        public GatewaySectionsNotRequiredService(IRoatpApplicationApiClient applyApiClient, 
                                                 IRoatpExperienceAndAccreditationApiClient accreditationClient, 
                                                 ILogger<GatewaySectionsNotRequiredService> logger)
        {
