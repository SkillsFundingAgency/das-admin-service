            ...
            viewmodel.Sequences = new List<GatewaySequence>
            {
                ...
                new GatewaySequence
                {
                    ...
                    Sections = new List<GatewaySection>
                    {
                        ...
                        new GatewaySection { SectionNumber = 2, PageId = "PayBack", UrlTag = "pay-back",  LinkTitle = "Failed to pay back funds", HiddenText = "for the organisation", Status = "" },
                        new GatewaySection { SectionNumber = 3, PageId = "ContractTerm", UrlTag = "contract-term", LinkTitle = "Contract terminated early by a public body", HiddenText = "for the organisation", Status = "" },
