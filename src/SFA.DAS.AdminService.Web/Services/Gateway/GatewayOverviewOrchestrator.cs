...
namespace SFA.DAS.AdminService.Web.Services.Gateway
{
    public class GatewayOverviewOrchestrator: IGatewayOverviewOrchestrator
    {
        ...
        public GatewayOverviewOrchestrator(IRoatpApplicationApiClient applyApiClient, IRoatpExperienceAndAccreditationApiClient accreditationClient,  
                                           ILogger<GatewayOverviewOrchestrator> logger, IGatewaySectionsNotRequiredService sectionsNotRequiredService)
        {
