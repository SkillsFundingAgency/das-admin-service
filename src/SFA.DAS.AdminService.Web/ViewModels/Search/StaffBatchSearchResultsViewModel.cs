    ...
    public class StaffBatchSearchResultViewModel
{
    ...
    private string FormatTrainingCourse(StaffBatchSearchResult searchResult)
    {
    ...
    private Dictionary<string, string> GenerateRouteData(StaffBatchSearchResult searchResult)
    {
        if (searchResult.StandardCode > 0)
        {
