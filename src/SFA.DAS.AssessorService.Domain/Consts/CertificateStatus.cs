...
namespace SFA.DAS.AssessorService.Domain.Consts
{
    public static class CertificateStatus
    {
        ...
        public static bool HasPrintProcessStatus(string certificateStatus)
        {
            return PrintProcessStatus.Contains(certificateStatus);
        }

        public static bool HasPrintNotificateStatus(string certificateStatus)
        {
            return PrintNotificationStatus.Contains(certificateStatus);
        }
