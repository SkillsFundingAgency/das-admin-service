...
namespace SFA.DAS.AdminService.Web.Tests.Controllers.CertificateTests.CertificateDelete
{
    public class GivenIRequestToDeleteCertificate : CertificateDeleteQueryBase
    {
        ...
        public void Arrange()
        {
            ...
            _sut = new CertificateDeleteController(MockedLogger.Object, MockHttpContextAccessor.Object, CertificateApiClient, LearnerDetailApiClient, OrganisationsApiClient, ScheduleApiClient, StandardVersionApiClient);
        }
        ...
        public void ThenThrowException()
        {
            ...
            _sut = new CertificateDeleteController(MockedLogger.Object, MockHttpContextAccessor.Object, client.Object, LearnerDetailApiClient, OrganisationsApiClient, ScheduleApiClient, StandardVersionApiClient);
